...
if(!isset($_SESSION['service'])){
	header("location:http://localhost/wordpress/labour/");
} else {
?>
...
header("Location: http://localhost/employMe/landmark1.php?page=0");
		...
		<div class="col-md-12">
			<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="background-color:white;height:76px;">
				<div class="navbar-header" style="padding-top:10px;">
					...
					</button> <a class="navbar-brand" href="http://localhost/wordpress/" onmouseover="this.style.backgroundColor=''" onmouseout="this.style.backgroundColor=''" style="font-size:30px;"><image src="http://localhost/wordpress/wp-content/themes/zerif-lite/images/logo.png" style="vertical-align: middle;"></a>
				</div>
...
<div id="suggest" style="padding-top:78px;">
   ...
   <center>
        ...
        <a href="http://localhost/employMe/cleaning1.php?page=0">Top Cleaners Jobs</a><br>
		<img src="images/mechanic.jpg" height="150px" width="150px"><br>
        <a href="http://localhost/employMe/mechanic1.php?page=0">Top Mechanics Jobs</a><br>
		<img src="images/carpenter.jpg" height="150px" width="150px"><br>
        <a href="http://localhost/employMe/carpenter1.php?page=0">Top Carpenter jobs</a><br>
		 <img src="images/plumber.jpg" height="150px" width="150px"><br>
        <a href="http://localhost/employMe/plumber1.php?page=0">Top Plumbering Jobs</a>
...
<input type="submit" id="submit" name="sms" value="SEND"/>
</form>
 </div>
<!-- Popup Div Ends Here -->
</div> 
...
<div style="padding-top:76px;">
    ...
    <option value="http://localhost/employMe/sort1.php?page=0">Ratings</option>
    </select>
...
<?php
      $sql = "SELECT count(id) FROM $service WHERE location='$location'";
        $retval = mysqli_query($conn, $sql);
         ...
         $index=0;
  $data = mysqli_query($conn,"SELECT * FROM $service WHERE location = '$location' AND vacancy>0 ORDER BY average_rating DESC LIMIT $offset, $rec_limit")  or die(mysqli_error($conn));		
...
<tr><td><img src="images/add.jpg" alt= "address" style="width:50px; height:50px"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$row['address']?></td></tr>
<?php $sms[$index] = $row['contact']; ?>
<tr><td><img src="images/ph.jpg" alt= "contact" style="width:50px; height:50px"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$sms[$index]?></td></tr>
<tr><td><img src="images/vac.jpg" alt= "contact" style="width:38px; height:38px"> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<?=$row['vacancy']?></td></tr>
<tr><td>
<input name="rating" value="0" class="rating_star" type="hidden" postID="<?php echo $row['id']; ?>" />
<?php
...
Based on <span id="totalrat"><?php echo $ratingRow['rating_number']; ?></span>  rating)</span></td></tr>
<tr>
<td><button id="popup" onclick="div_show()" class="button-0" width="40px" height="30px">SMS</button></td>
</tr>
</tr>
</table>
</td>
