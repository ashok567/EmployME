...
<header id="home" class="header">
	...
	<div id="main-nav" class="navbar navbar-inverse bs-docs-nav">
		...
		<div id="wrapper">
				...
				<input type="search" class="search-field" placeholder="<?php echo esc_attr_x( 'Search Location &hellip;', 'placeholder', 'zerif-lite' ); ?>" value="<?php echo esc_attr( get_search_query() ); ?>" name="s" title="<?php _ex( 'Search for:', 'label', 'zerif-lite' ); ?>">  
                                      </label>
