...
<div id="suggest" style="padding-top:78px;">
    ...
    <center>
        ...
        <a href="http://localhost/employMe/carpenter.php?page=0">Top Carpenter</a><br>
        ...
        <a href="http://localhost/employMe/mechanic.php?page=0">Top Mechanics</a>
...
<?php
      $sql = "SELECT count(id) FROM $service WHERE location='$location'";
		...
		$index =0;
  $data = mysqli_query($conn,"SELECT * FROM $service WHERE location = '$location' ORDER BY average_rating DESC LIMIT $offset, $rec_limit")  or die(mysqli_error($conn));
